...
namespace TreeEditor
{
    ...
    public class Actions
    {
        ...
        public static void LoadPage(Form1 form1,string textFile, string csvFile)
        {
            ...
            System.Console.WriteLine("ロードページ　予想ツリーファイル：" + form1.UiMain1.GetTreeCsvFile(form1.UiMain1.Contents.ProjectName, false));
        ...
        public static void SavePage(Form1 form1)
        {
            ...
            System.Console.WriteLine("セーブページ　予想ツリーファイル：" + form1.UiMain1.GetTreeCsvFile(form1.UiMain1.Contents.ProjectName, false));
            ...
            try
            {
                ...
                File.WriteAllText(
                    form1.UiMain1.GetTreeCsvFile(form1.UiMain1.Contents.ProjectName, false),
                    contents,
        ...
        public static void Buckup(UiMain uiMain)
        {
            ...
            {
                //コピー先ディレクトリー
                string file = uiMain.GetTreeCsvFile(uiMain.Contents.ProjectName, true);
                ...
                File.Copy(
                    uiMain.GetTreeCsvFile(uiMain.Contents.ProjectName, false),
                    file,
                    true
                    );
            }
            ...
            {
                System.Console.WriteLine("ツリーCSVのバックアップに失敗　[" + uiMain.GetTreeCsvFile(uiMain.Contents.ProjectName, false) + "]→[" + uiMain.GetTreeCsvFile(uiMain.Contents.ProjectName, true) + "]　：" + exc.Message);
            }
            ...
            {
                //コピー先ディレクトリー
                string file = uiMain.GetTextFile(uiMain.Contents.ProjectName, uiMain.UiTextside1.NodeNameTxt1.Text, true);
                string dir = Path.GetDirectoryName(file);
                ...
                File.Copy(
                    uiMain.GetTextFile(uiMain.Contents.ProjectName, uiMain.UiTextside1.NodeNameTxt1.Text, false),
                    file,
                    true
                    );
            }
            ...
            {
                System.Console.WriteLine("カレント・テキストTXTのバックアップに失敗　[" + uiMain.GetTextFile(uiMain.Contents.ProjectName, uiMain.UiTextside1.NodeNameTxt1.Text, false) + "]→[" + uiMain.GetTextFile(uiMain.Contents.ProjectName, uiMain.UiTextside1.NodeNameTxt1.Text, true) + "]　：" + exc.Message);
            }
            ...
            {
                //コピー先ディレクトリー
                string file = uiMain.GetResourceCsvFile(uiMain.Contents.ProjectName, uiMain.UiTextside1.NodeNameTxt1.Text, true);
                string dir = Path.GetDirectoryName(file);
                ...
                File.Copy(
                    uiMain.GetResourceCsvFile(uiMain.Contents.ProjectName, uiMain.UiTextside1.NodeNameTxt1.Text, false),
                    file,
                    true
                    );
            }
            ...
            {
                System.Console.WriteLine("カレント・リソースCSVのバックアップに失敗　[" + uiMain.GetResourceCsvFile(uiMain.Contents.ProjectName, uiMain.UiTextside1.NodeNameTxt1.Text, false) + "]→[" + uiMain.GetResourceCsvFile(uiMain.Contents.ProjectName, uiMain.UiTextside1.NodeNameTxt1.Text, true) + "]　：" + exc.Message);
            }
        }
    }
}
