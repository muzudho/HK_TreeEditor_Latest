...
namespace TreeEditor
{
    public partial class NodePropertyDialog : Form
    {
        ...
        public string NodeText
        {
            get
            {
                return this.nodeTextTxt.Text;
            }
            set
            {
                this.nodeTextTxt.Text = value;
            }
        }

        /// <summary>
        /// .rtfファイル。プロジェクト・フォルダーからの相対パス。
        /// </summary>
        public string RtfRel
        {
            get
            {
                return this.rtfRelTxt.Text;
            }
            set
            {
                this.rtfRelTxt.Text = value;
            }
        }
        ...
        {
            this.nodeTextTxt.ForeColor = Color.FromArgb(255, this.ForeRed, this.ForeGreen, this.ForeBlue);
            this.nodeTextTxt.BackColor = Color.FromArgb(255, this.BackRed, this.BackGreen, this.BackBlue);
        }
        ...
        private void nodeFileTxt_TextChanged(object sender, EventArgs e)
        {
            if (this.Owner is Form1)
            {
                Form1 form1 = (Form1)this.Owner;
                ...
                if (duplicate)
                {
                    ...
                    this.nameCommentLbl.Text = "既にあるファイル名です。";
                }
                else
                {
                    this.nameCommentLbl.ForeColor = Color.Red;
                    this.nameCommentLbl.Text = "ファイル名を変更します。";
                }
