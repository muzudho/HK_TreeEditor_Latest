...
namespace TreeEditor
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Control && Keys.V == e.KeyCode)
            {
                ...
                if (this.UiMain1.UiTextside1.RichTextBox1.Focused)
                {
                    ...
                    if (this.UiMain1.Contents.AnotherPageCopy == 2)
                    {
                        if (data != null &&
                            ...
                            )
                        {
                            ...
                            if (data.GetDataPresent(DataFormats.Rtf))
                            {
                                ...
                                System.Console.WriteLine("リッチテキストボックスへ、RTF[" + data.GetData(DataFormats.Rtf) + "]をペーストしたい。");
                            ...
                            else if (data.GetDataPresent(DataFormats.Text))
                            {
                                ...
                                System.Console.WriteLine("リッチテキストボックスへ、テキスト[" + data.GetData(DataFormats.Text) + "]をペーストしたい。");

                                this.UiMain1.UiTextside1.RichTextBox1.Paste(DataFormats.GetFormat(DataFormats.Text));
                            }
                            else
                            {
                                System.Console.WriteLine("リッチテキストボックスへ、内部実装任せでペーストしたい。");
                        ...
                        else
                        {
                            ...
                            {
                                System.Console.WriteLine("ペーストしたいＢ。format=[" + format+"]");
                            }
                        }
                    ...
                    {
                        //System.Console.WriteLine("ペーストしたいＡ。内部実装任せ　this.UiMain1.Contents.AnotherPageCopy=[" + this.UiMain1.Contents.AnotherPageCopy + "]　this.UiMain1.UiTextside1.RichTextBox1.Focused=[" + this.UiMain1.UiTextside1.RichTextBox1.Focused + "]");

                        //ペーストしたいＡ。format=[EditEngineFormat]
                        //ペーストしたいＡ。format=[System.String]
                        //ペーストしたいＡ。format=[UnicodeText]
                        //ペーストしたいＡ。format=[Text]
                        //ペーストしたいＡ。format=[Rich Text Format]

                        // オープン・オフィスの表計算などからコピーすると、
                        // EditEngineFormat が入っているが、
                        // 「ＭＳＰゴシック攻撃回数」のようにフォント名まで入ってしまっている。
                        bool isEditEngineFormat = false;

                        foreach (string format in data.GetFormats())
                        {
                            if (format == "EditEngineFormat")
                            {
                                isEditEngineFormat = true;
                                break;
                            }
                            //ystem.Console.WriteLine("ペーストしたいＡ。format=[" + format + "]");
                        }

                        if (isEditEngineFormat)
                        {
                            // 一旦、テキストボックスに貼り付けます。
                            ...
                            // あとは、リッチテキストボックスにもとから付いているペースト機能が、ペーストします。
                            //his.UiMain1.UiTextside1.RichTextBox1.Paste();
                        }
                        else
                        {
                        }
                        ...
                        //    System.Console.WriteLine("リッチテキストボックスへＡ、RTF[" + data.GetData(DataFormats.Rtf) + "]をペーストしたい。");
                        ...
                        //    System.Console.WriteLine("リッチテキストボックスへＡ、テキスト[" + data.GetData(DataFormats.Text) + "]をペーストしたい。");

                        //    this.UiMain1.UiTextside1.RichTextBox1.Paste(DataFormats.GetFormat(DataFormats.Text));
                        //}
                        //else
                        //{
                        //    System.Console.WriteLine("リッチテキストボックスへＡ、内部実装任せでペーストしたい。");
        ...
        {
            Actions.FormClosing(this, sender, e);
