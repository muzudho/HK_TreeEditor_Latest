...
namespace TreeEditor
{
    public class Utility
    {
        ...
        public static void CreateRtf(UiMain uiMain1, string projectFolder, string rel, out string contents)
        {
            contents = "";

            string abs = uiMain1.GetFileFull(projectFolder, rel, false);

            if (!File.Exists(abs))
            {
                //ystem.Console.WriteLine("★RTF作成：無いので新規作成：　abs[" + abs + "]");
            ...
            {
                //ystem.Console.WriteLine("★RTF作成：既存なので無視：　abs[" + abs + "]");
            }
        }


        public static void CreateCsv(UiMain uiMain1, string projectFolder, string rel, out string contents)
        {
            contents = "";
        ...
        public static void CreateText(UiMain uiMain1, string projectFolder, string rel, out string contents)
        {
            contents = "";
