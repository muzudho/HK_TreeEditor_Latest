...
namespace TreeEditor
{
    public partial class UiTextside : UserControl
    {
        ...
        public void AddPictBox(string fileAbs, Point p2, bool isLeftTop)
        {
            ...
            if (this.IsImageCsvMode)
            {
                ...
                {
                    //左上座標 → 中心座標に変換します。
                    pic1.LocationCInAll = new Point(
                        p2.X + this.CsvMode.RichScrollbar.Head.X + pic1.Width / 2,
                        p2.Y + this.CsvMode.RichScrollbar.Head.Y + pic1.Height / 2
                    );
                }
                else
                {
                    ...
                    pic1.LocationCInAll = new Point(
                        p2.X + this.CsvMode.RichScrollbar.Head.X,
                        p2.Y + this.CsvMode.RichScrollbar.Head.Y
                        );
                }
            ...
            if (e.Data.GetDataPresent(DataFormats.FileDrop))
            {
                ...
                foreach (string fileName in fileNames)
                {
                    try
                    {
                        ...
                        // 中心座標で指定します。
                        this.AddPictBox(fileName, p2, false);
                    }
                    catch (Exception)
                    {
                        // 画像ではなかった場合。
        ...
        void pic1_MouseLeave(object sender, EventArgs e)
        {
            Form1 form1 = (Form1)this.ParentForm;
            this.CsvMode.Pic1_MouseLeave(form1, sender, e);
        }
        ...
        {
            PictureBox pic1 = this.CsvMode.MouseupPictBox;
