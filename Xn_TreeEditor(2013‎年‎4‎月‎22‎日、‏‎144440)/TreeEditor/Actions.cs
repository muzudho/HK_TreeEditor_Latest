                ...
                try
                {
                    ...
                    if (log_Reports.Successful)
                    {
                        table.ForEach_Datapart(delegate(Record_Humaninput recordH, ref bool isBreak2, Log_Reports log_Reports2)
                        {
                            ...
                            form1.UiMain1.UiTextside1.AddPictBox(picAbs, new Point(xN, yN), true);
                    ...
                    if ("" != csvRel)
                    {
                        ...
                        foreach (Control c in form1.UiMain1.UiTextside1.RichTextBox1.Controls)
                        {
                            if (c is PictBox)
                            {
                                ...
                                // 表示中の絶対座標（画像の中心座標）。
                                sb.Append(pic.LocationCInAll.X);//pic.Location.X + form1.UiMain1.Contents.ScrollX
                                sb.Append(",");

                                sb.Append(pic.LocationCInAll.Y);//pic.Location.Y + form1.UiMain1.Contents.ScrollY
