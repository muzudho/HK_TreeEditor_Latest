...
namespace TreeEditor
{
    ...
    public class Actions
    {
            ...
            //━━━━━
            {
                ...
                if (ofd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    form1.UiMain1.OpenProjectLaw(
                        Path.GetFileNameWithoutExtension(tefAbs),
                        tefAbs
                        );
                }
            }
            ...
            if (reslut1 == DialogResult.OK)
            {
                ...
                //━━━━━
                {
                    ...
                    if ("" != folder)
                    {
                        ...
                        {
                            form1.UiMain1.CreateDefaultProjectLaw(folder, true);
                            form1.UiMain1.OpenProjectLaw(
                ...
                try
                {
                    ...
                    if (log_Reports.Successful)
                    {
                        table.ForEach_Datapart(delegate(Record_Humaninput recordH, ref bool isBreak2, Log_Reports log_Reports2)
                        {
                            ...
                            form1.UiMain1.UiTextside1.AddPicture(picAbs, new Point(xN, yN), true);
        ...
        private static void SaveTxt(Form1 form1, string rtfRel, string txtContents)
        {
            ...
            //━━━━━
            {
                ...
                if (!File.Exists(txtAbs))
                {
                    ...
                    string contents;
                    Utility.CreateText(form1.UiMain1, txtRel, out contents);
                }
                else
                {
                    // あれば出力します。
                    ...
                    if ("" != csvRel)
                    {
                        ...
                        foreach (Control c in form1.UiMain1.UiTextside1.RichTextBox1.Controls)
                        {
                            if (c is PictureBox)
                            {
                                ...
                                // 表示中の絶対座標から、スクロールした量を引きます。
                                sb.Append(pic.Location.X + form1.UiMain1.Contents.ScrollX);
                                sb.Append(",");

                                sb.Append(pic.Location.Y + form1.UiMain1.Contents.ScrollY);
        ...
        public static void Buckup(UiMain uiMain)
        {
            ...
            {
                //コピー先ディレクトリー
                string rel = uiMain.Contents.RtfFileRel;
            ...
            {
                System.Console.WriteLine("カレントRTFのバックアップに失敗　[" + uiMain.GetFileFull(uiMain.Contents.ProjectFolder, uiMain.Contents.RtfFileRel, false) + "]→[" + uiMain.GetFileFull(uiMain.Contents.ProjectFolder, uiMain.Contents.RtfFileRel, true) + "]　：" + exc.Message);
            }
            ...
            {
                //コピー先ディレクトリー
                string rel = Utility.RtfToTxt(uiMain.Contents.RtfFileRel);
                string bkAbs = uiMain.GetFileFull(uiMain.Contents.ProjectFolder, rel, true);
                string dir = Path.GetDirectoryName(bkAbs);
            ...
            {
                System.Console.WriteLine("カレントTXTのバックアップに失敗　[" + uiMain.GetFileFull(uiMain.Contents.ProjectFolder, uiMain.Contents.RtfFileRel, false) + "]→[" + uiMain.GetFileFull(uiMain.Contents.ProjectFolder, uiMain.Contents.RtfFileRel, true) + "]　：" + exc.Message);
            }
            ...
            {
                //コピー先ディレクトリー
                string rel = Utility.RtfToCsv(uiMain.Contents.RtfFileRel);
                string bkAbs = uiMain.GetFileFull(uiMain.Contents.ProjectFolder, rel, true);
                string dir = Path.GetDirectoryName(bkAbs);
                //ystem.Console.WriteLine("BK_TXT：bkAbs[" + bkAbs + "]　[" + dir + "]");
            ...
            {
                System.Console.WriteLine("カレントCSVのバックアップに失敗　[" + uiMain.GetFileFull(uiMain.Contents.ProjectFolder, uiMain.Contents.RtfFileRel, false) + "]→[" + uiMain.GetFileFull(uiMain.Contents.ProjectFolder, uiMain.Contents.RtfFileRel, true) + "]　：" + exc.Message);
            }
        }
        ...
        public static TreeNode2 AppendChildNode(UiMain uiMain1)
        {
            ...
            {
                string contents;
                Utility.CreateRtf( uiMain1, nodeRel, out contents);
            }
        ...
        private static void ChangeRtfRel(UiMain uiMain1, TreeNode2 selectedNode, string newRtfRel)
        {
            ...
            {
                string contents = "";
                Utility.CreateRtf(uiMain1, srcRtfRel, out contents);
        ...
        /// <param name="e"></param>
        public static void ApplicationExit(Form1 form1, object sender, EventArgs e)
        {
            //essageBox.Show("アプリケーションが終了されます。\n[" + form1.UiMain1.Contents.ProjectFolder + "]");
            ...
            //━━━━━
            {
                try
                {
                    ...
                    string treeAbs = form1.UiMain1.GetTreeCsvFile(form1.UiMain1.Contents.ProjectFolder, false);
                    if (System.IO.File.Exists(treeAbs))
                    {
                        Actions.DeleteDirectory(form1.UiMain1.Contents.ProjectFolder);
                        //ystem.IO.Directory.Delete(form1.UiMain1.Contents.ProjectFolder, true);
                    }
                }
                catch (Exception e2)
                {
                    MessageBox.Show("[" + form1.UiMain1.Contents.ProjectFolder + "]\nフォルダーの削除に失敗しました。\n\n" + e2.Message, "強制終了を回避！　Application_ApplicationExit", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }


            //ApplicationExitイベントハンドラを削除
            Application.ApplicationExit -= new EventHandler(form1.Application_ApplicationExit);
        }
