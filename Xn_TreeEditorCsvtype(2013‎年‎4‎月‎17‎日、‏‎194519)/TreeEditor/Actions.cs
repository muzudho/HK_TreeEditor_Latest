...
namespace TreeEditor
{
    ...
    public class Actions
    {
                ...
                try
                {
                    ...
                    if (log_Reports.Successful)
                    {
                        table.ForEach_Datapart(delegate(Record_Humaninput recordH, ref bool isBreak2, Log_Reports log_Reports2)
                        {
                            ...
                            PictureBox pic1 = form1.UiMain1.UiTextside1.NewPictureBox(rFile, new Point(xN, yN),true);
                            if (null != pic1)
                            {
                                //中心座標に変更
        ...
        public static void LoadPage(Form1 form1,string textFile, string rtfFile, string csvFile)
        {
            Log_Method log_Method = new Log_MethodImpl();
            Log_ReportsImpl log_Reports = new Log_ReportsImpl(log_Method);
            ...
            if (form1.UiMain1.Contents.IsRtfMode)
            {
        ...
        public static void Save(Form1 form1)
        {
            ...
            if (form1.UiMain1.Contents.IsRtfMode)
            {
                if ("" != form1.UiMain1.Contents.RtfFile)
                {
                    //━━━━━
                    //RTF書出し
                    //━━━━━
