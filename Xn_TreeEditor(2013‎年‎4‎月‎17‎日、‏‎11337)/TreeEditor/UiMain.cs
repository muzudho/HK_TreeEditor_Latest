...
namespace TreeEditor
{
    public partial class UiMain : UserControl
    {
        ...
        public void RefreshTitleBar()
        {
            ...
            //プロジェクト・フォルダー
            sb.Append(this.Contents.ProjectFolder);
        ...
        public void CreateDefaultProject(string projectFolder)
        {
            ...
            try
            {
                System.IO.File.Copy(@"img\listIcon0.png", @"save\" + projectFolder + @"\img-listicon\0.png");
                System.IO.File.Copy(@"img\listIcon1.png", @"save\" + projectFolder + @"\img-listicon\1.png");
                System.IO.File.Copy(@"img\listIcon2.png", @"save\" + projectFolder + @"\img-listicon\2.png");
                System.IO.File.Copy(@"img\listIcon3.png", @"save\" + projectFolder + @"\img-listicon\3.png");
            }
            catch (Exception)
            {
            }
