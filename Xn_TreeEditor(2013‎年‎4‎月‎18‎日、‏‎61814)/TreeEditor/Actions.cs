...
namespace TreeEditor
{
    ...
    public class Actions
    {
        ...
        public static void LoadPageCsv(Form1 form1, string rel)
        {
        ...
        public static void SaveRtfCsv(Form1 form1, string rtfRel, string rtfContents)
        {
            string csvRel = TreeNode2.RtfToCsv(rtfRel);
        ...
        public static void Save(Form1 form1)
        {
            ...
            System.Console.WriteLine("セーブ　予想CSVファイル：" + form1.UiMain1.GetFileFull(form1.UiMain1.Contents.ProjectFolder, TreeNode2.RtfToCsv( form1.UiMain1.Contents.RtfFileRel), false));
            ...
            if (null != uiMain1.TreeView1.SelectedNode && uiMain1.TreeView1.SelectedNode is TreeNode2)
            {
                ...
                if (isSuccessful)
                {
                    ...
                    if (((TreeNode2)uiMain1.TreeView1.SelectedNode).File != dlg.NodeFile)
                    {
                        ...
                        // ファイル名を変更した場合
                        //━━━━━
                        Actions.ChangeNodeFile3(uiMain1, (TreeNode2)uiMain1.TreeView1.SelectedNode, dlg.NodeFile, TreeNode2.RtfToCsv(dlg.NodeFile));
        ...
        private static void ChangeNodeFile3(UiMain uiMain1, TreeNode2 selectedNode, string newRtfRel, string newCsvRel)
        {
                    ...
                    else
                    {
                        ...
                        foreach (string line in lines)
                        {
                            ...
                            if (line2.StartsWith("."))
                            {
                                ...
                                Actions.ChangeNodeFile3(uiMain1, tn, rtfRel2, TreeNode2.RtfToCsv(rtfRel2));
                            }
                            else
                            {
